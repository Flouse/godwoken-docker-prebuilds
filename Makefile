...
# components tags
GODWOKEN_REF := refs/pull/717/head # https://github.dev/nervosnetwork/godwoken/pull/717
GODWOKEN_SCRIPTS_REF := master # https://github.com/nervosnetwork/godwoken-scripts/commits/f836e55ac
