...
POLYJUICE_REPO := https://github.com/flouse/godwoken-polyjuice.git
CLERKB_REPO := https://github.com/nervosnetwork/clerkb.git

# components tags
GODWOKEN_REF := v0.6.5-rc2
GODWOKEN_SCRIPTS_REF := v0.8.2-rc1
POLYJUICE_REF := update-gwScripts-and-moleculec
CLERKB_REF := v0.4.0
